...
$mchid = '1225312702';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wx426b3015555a46be';  //微信支付申请对应的公众号的APPID
$appKey = '01c6d59a3f9024db6336662ac95c8e74';   //微信支付申请对应的公众号的APP Key
$apiKey = 'e10adc3949ba59abbe56e057f20f883e';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
...
$payAmount = $pay_amount;          //付款金额，单位:元
$orderName = '支付测试';    //订单标题
$notifyUrl = 'http://doc.fnying.com/api/wx_pay_syc/notify.php';     //付款成功后的回调地址(不要有问号)
$payTime = time();      //付款时间
...
class WxpayService
{
    ...
    public function GetOpenid()
    {
        ...
        if (!isset($_GET['code'])){
            ...
            $baseUrl =   'http://paysdk.weixin.qq.com/jsapi.php';
